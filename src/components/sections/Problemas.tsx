...
const titles = ['Sem previsibilidade', 'Sem clareza de investimento', 'Sem estratégia de lance'];
...
export default function Problemas({ config }: any) {
  ...
  return (
    <section ref={ref} id="problemas" className="py-24 bg-client-bg relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          {config.itens.map((item: any, i: number) => {
            ...
            return (
              <div key={item.id} className={`group bg-white rounded-[20px] p-8 relative overflow-hidden transition-all duration-400 border border-[rgba(15,38,64,.06)] hover:-translate-y-1.5 hover:shadow-[0_20px_60px_rgba(15,38,64,.18)] hover:border-client-accent reveal ${i === 0 ? 'reveal-delay-1' : i === 1 ? 'reveal-delay-2' : 'reveal-delay-3'}`}>
                ...
                <h3 className="font-display text-lg text-client-primary mb-2">{titles[i]}</h3>
